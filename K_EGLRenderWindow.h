...
=========================================================================*/
/**
 * @class   K_EGLRenderWindow
 * @brief   OpenGL rendering window
 *
 * K_EGLRenderWindow is a concrete implementation of the abstract class
...
#ifndef K_EGLRenderWindow_h
#define K_EGLRenderWindow_h
...
class VTKRENDERINGOPENGL2_EXPORT K_EGLRenderWindow : public vtkOpenGLRenderWindow
{
public:
  static K_EGLRenderWindow *New();
  vtkTypeMacro(K_EGLRenderWindow, vtkOpenGLRenderWindow);
...
protected:
  ...
  void SetXWindowAsDisplay();

private:
  K_EGLRenderWindow(const K_EGLRenderWindow&) = delete;
  void operator=(const K_EGLRenderWindow&) = delete;
